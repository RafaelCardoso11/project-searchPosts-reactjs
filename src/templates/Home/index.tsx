  ...
  return (
    <section className="container">
      <div className="search-container">
        <Input type={'search'} placeHolder={'Search...'} event={handleChange} value={searchValue} />
      </div>
      ...
      <div className="button-Container">
        {!searchValue && <Button text={'Load more Posts'} event={loreMorePosts} disabled={noMorePosts} />}
      </div>
    </section>
  );
};
